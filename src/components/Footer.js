...
import Foot from "./Home/sections/Footer"
          ...
          <section className={`form sm:mt-10 bg-secondary`}>
            <div
              ...
              <div className="sm:mt-10">
                <a rel="nofollow" href="https://play.google.com/store/apps/details?id=com.go.social.prod&referrer=utm_source%3Dgetgosocial.app%26utm_medium%3Dfooter%26utm_term%3Dget%252Bit%252Bon%252Bplaystore%26utm_campaign%3Dlanding_page" className="inline-flex text-white hover:text-white shadow sm:shadow-none mt-4 md:mt-0 flex-grow bg-primary p-3 sm:py-4 sm:px-6 rounded cursor-pointer" target="__new">
